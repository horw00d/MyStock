...
const SidebarLink = ({
    ...
    //used to determine what to highlight in sidebar
...
const Sidebar = () => {
    ...
    //sidebar is a flexbox in the column direction
    const sidebarClassNames = `fixed flex flex-col ${
        //collapsed makes width 0 on smaller screens
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            >
                <Image
                    src="https://s3-mystock.s3.us-east-1.amazonaws.com/logo.png"
                    alt={"Logo"}
                    width={27}
                    height={27}
